...
# arguments
path = '/Users/osanai/Documents/GitHub/python-library/library_checker/graph/cycle_detection_undirected.test.py'
basedir = '/Users/osanai/Documents/GitHub/python-library'

# run library_checker/graph/cycle_detection_undirected.test.py
env = dict(os.environ)
