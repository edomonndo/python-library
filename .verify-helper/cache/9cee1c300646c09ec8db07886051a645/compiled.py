...
# arguments
path = '/Users/osanai/Documents/GitHub/python-library/library_checker/data_structure/unionfind.test.py'
basedir = '/Users/osanai/Documents/GitHub/python-library'

# run library_checker/data_structure/unionfind.test.py
env = dict(os.environ)
