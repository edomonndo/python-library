...
class Modint:
    ...
    def __imul__(self, rhs: "Modint" | int) -> "Modint":
        if isinstance(rhs, Modint):
    ...
    def __ifloordiv__(self, rhs: "Modint" | int) -> "Modint":
        if isinstance(rhs, Modint):
            inv = rhs.inv()._v
        else:
    ...
    def __add__(self, rhs: "Modint" | int) -> "Modint":
        if isinstance(rhs, Modint):
    ...
    def __sub__(self, rhs: "Modint" | int) -> "Modint":
        if isinstance(rhs, Modint):
            result = self._v - rhs._v
            if result < 0:
                result += self._mod
    ...
    def __mul__(self, rhs: "Modint" | int) -> "Modint":
        if isinstance(rhs, Modint):
    ...
    def __ne__(self, rhs: "Modint" | int) -> bool:  # type: ignore
        if isinstance(rhs, Modint):
            return self._v != rhs._v
        else:
            return self._v != rhs
